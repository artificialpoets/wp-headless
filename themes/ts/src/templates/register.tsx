...
export function Register({ runtime, request }: RegisterProps) {
  ...
  if (isLoggedIn) {
    return (
      <div className={styles.wrap}>
        ...
        <p className={styles.intro}>You are signed in. {urls.logout && <a href={urls.logout}>Log out</a>} first if you want to register a new account.</p>
      </div>
    )
  }
  ...
  return (
    <div className={styles.wrap}>
      ...
      >
        ...
        <label className={styles.label}>
          Email
          <input type="email" name="user_email" className={styles.input} autoComplete="email" required />
        </label>
