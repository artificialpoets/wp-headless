...
const devRuntime: WPHeadlessRuntime = {
  site: {
  ...
  postTypes: [
    ...
    { name: 'page', label: 'Pages', singular: 'Page', rest_base: 'pages', has_archive: false, archive_link: null, hierarchical: true, show_in_rest: true, builtin: true, supports_comments: false, supports_thumbnail: true },
  ],
  discussion: {
